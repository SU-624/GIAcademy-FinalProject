...
public class Professor
{
    ...
    public List<ProfessorStat> GameManagerProcessor
    {
...
//    [SerializeField] private SelectClass m_ClassPrefabData;
...
//        {
//            if (m_LoadProfessorData.professorData.ElementAt(i).Value.m_ProfessorType == StudentType.Art)
//            {
//                m_NowPlayerProfessor.ArtProcessor.Add(m_LoadProfessorData.professorData.ElementAt(i).Value);
//            }

//            if (m_LoadProfessorData.professorData.ElementAt(i).Value.m_ProfessorType == StudentType.GameDesigner)
//            {
//                m_NowPlayerProfessor.ProductManagerProcessor.Add(m_LoadProfessorData.professorData.ElementAt(i).Value);

//            }

//            if (m_LoadProfessorData.professorData.ElementAt(i).Value.m_ProfessorType == StudentType.Programming)
//            {
...
//        if (m_ClassPrefabData.m_SelecteClassDataList[_tempIndex].m_ClassType == StudentType.Art)
//        {
...
//        }
//        else if (m_ClassPrefabData.m_SelecteClassDataList[_tempIndex].m_ClassType == StudentType.GameDesigner)
//        {
//            SetArrowButtons();
...
//        }
//        else if (m_ClassPrefabData.m_SelecteClassDataList[_tempIndex].m_ClassType == StudentType.Programming)
//        {
//            SetArrowButtons();
