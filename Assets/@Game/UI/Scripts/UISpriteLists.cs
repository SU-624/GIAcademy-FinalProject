...
public class UISpriteLists : MonoBehaviour
{
    ...
    private List<Sprite> StudentPersonalitySpriteList = new List<Sprite>();     // 학생 성격 이미지 모음

    private List<Sprite> TimeBarSpriteList = new List<Sprite>();                // 이벤트 - 타임바 이미지
    ...
    string StudentPersonalitySpriteFolder;
    string TimeBarSpriteListFolder;
    ...
    public List<Sprite> GetStudentPersonalitySpriteList
    {
        get { return StudentPersonalitySpriteList; }
        set { StudentPersonalitySpriteList = value; }
    }

    public List<Sprite> GetTimeBarSpriteList
    {
        get { return TimeBarSpriteList; }
        set { TimeBarSpriteList = value; }
    }
    ...
    void Start()
    {
        ...
        StudentPersonalitySpriteFolder = "StudentPersonalitySprite";
        TimeBarSpriteListFolder = "EventTimeBarSprite";
    ...
    public void InitializeSpriteLoad()
    {
        ...
        LoadStudentPersonalitySprite();
        LoadTimeBarSpriteList();
    }
    ...
    public void LoadStudentPersonalitySprite()
    {
        var r = Resources.LoadAll<Sprite>(StudentPersonalitySpriteFolder);

        foreach (var temp in r)
        {
            StudentPersonalitySpriteList.Add(temp);
        }

        StudentPersonalitySpriteList = StudentPersonalitySpriteList.OrderBy(i => i.name).ToList();        // 오름차순
    }

    public void LoadTimeBarSpriteList()
    {
        var r = Resources.LoadAll<Sprite>(TimeBarSpriteListFolder);

        foreach (var temp in r)
        {
            TimeBarSpriteList.Add(temp);
        }

        TimeBarSpriteList = TimeBarSpriteList.OrderBy(i => i.name).ToList();        // 오름차순
    }
}
