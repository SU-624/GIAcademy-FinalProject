...
public class EachClass
{
    ...
    private List<Class> m_GameDesignerClass = new List<Class>();         // 기획
    private List<Class> m_ArtClass = new List<Class>();           // 아트
    private List<Class> m_ProgrammingClass = new List<Class>();   // 플머
    private List<Class> m_CommonClass = new List<Class>();
    // private List<Class> m_Design = new List<Class>();        // 수연이의 데이터와 연결 하면 쓸 변수

    #region EachClass_Property
    public List<Class> GameDesignerClass
    {
        get { return m_GameDesignerClass; }
        set { m_GameDesignerClass = value; }
    }
    ...
    public List<Class> NoneClass
    {
        get { return m_CommonClass; }
        set { m_CommonClass = value; }
    }
...
//        {
//            if (m_LoadClassData.classData.ElementAt(i).Value.m_ClassType == StudentType.Art)
//            {
...
//            if (m_LoadClassData.classData.ElementAt(i).Value.m_ClassType == StudentType.GameDesigner)
//            {
...
//            if (m_LoadClassData.classData.ElementAt(i).Value.m_ClassType == StudentType.Programming)
//            {
